...
SECTION .data
msg db 'Hello world, and here is some more text!', 0ah ; assign message varibale with the string that is our message, 0ah is linefeed
; Because we now have a longer string, and we have not updated the length of the string, only the first 13 bytes will be printed, as before.
