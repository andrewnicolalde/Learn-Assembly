; This file wil segfault
SECTION .data
msg db 'Hello world! This is a long message which we will try to determine the length of with subroutines. and we arent pushing ebx', 0ah
